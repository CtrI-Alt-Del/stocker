import { IBatchesRepository, IProductsRepository, IInventoryMovementsRepository } from "#interfaces/repositories";
...
export class RegisterOutboundInventoryMovementUseCase {
  ...
  constructor(batchRepository: IBatchesRepository, productsRepository: IProductsRepository, inventorymovementRepository: IInventoryMovementsRepository) {
		this.batchRepository = batchRepository, this.productsRepository = productsRepository, this.inventorymovementRepository = inventorymovementRepository
	}
